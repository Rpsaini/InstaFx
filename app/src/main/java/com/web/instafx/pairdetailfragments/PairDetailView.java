package com.web.instafx.pairdetailfragments;
...
import com.web.instafx.allorders.AllOrdersFrag;
import com.web.instafx.communication.SocketHandlers;
import com.web.instafx.trades.TradesFrag;
...
public class PairDetailView extends BaseActivity
{
    ...
    public void initRate(String changenew, String currentBuyPrice1, String sellPrice1) {
        ...
        if (changenew.contains("+")) {
            rr_change.setBackgroundResource(R.drawable.orrange_drawable);
